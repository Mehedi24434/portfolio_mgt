...
def multi_shift(df, shift=3):
    """Get last N rows relative to another row in pandas      3 set data ke pashapashi rakhe jeno 1st er ta latest dtaset, 2nd ta taar ager din er data set, 3rd ta taar ager din er data set"""
